...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cbreezycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cbreezycoin-tx [options] <hex-tx> [commands]  Update hex-encoded cbreezycoin transaction\n" +
            "or:     cbreezycoin-tx [options] -create [commands]   Create hex-encoded cbreezycoin transaction\n" +
            "\n";
