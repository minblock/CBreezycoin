...
{
    const char* pszTimestamp = "4/2/2020 Provigen.net: Now accepting Purple Tipped Ramachips!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586069668, 4327449, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xee6c304734a2e85f440b8e7cef57b6a7f0cc976a39a4073f5bdc19c7820b3ad3"));
        assert(genesis.hashMerkleRoot == uint256S("0x076045fef67cd96c5ea59a952fc26ed23bd84c136eb4bc29aaed4cdc6b094506"));
        ...
        vSeeds.emplace_back("seed-a.cbreezycoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.cbreezycointools.com");
        vSeeds.emplace_back("dnsseed.cbreezycoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 574702, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x99ded706bac779ed5b660389a94e38cba8d3c150fa6c82d0749a49fe95cf2eb8"));
        assert(genesis.hashMerkleRoot == uint256S("0x076045fef67cd96c5ea59a952fc26ed23bd84c136eb4bc29aaed4cdc6b094506"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.cbreezycointools.com");
        vSeeds.emplace_back("seed-b.cbreezycoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xdf21ce6f3c6d4eac71981924fc7564ee46ca7114f691b9c960aad4684b0f6fe7"));
        assert(genesis.hashMerkleRoot == uint256S("0x076045fef67cd96c5ea59a952fc26ed23bd84c136eb4bc29aaed4cdc6b094506"));
