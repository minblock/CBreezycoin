# Support for Output Descriptors in Cbreezycoin Core

Since Cbreezycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Cbreezycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Cbreezycoin Core wallets, a convenience function `combo` is
