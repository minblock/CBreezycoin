...
"""Verify that starting cbreezycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cbreezycoin with -h for help text")
        ...
        self.log.info("Start cbreezycoin with -version for version information")
        ...
        self.log.info("Start cbreezycoind with -fakearg to make sure it does not start")
